...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_w16404z','template_o7k42la', formRef.current, '6x20FMozLXe8KQWZq')
        .then((result) => {
            setSuccess(true)
        }, (error) => {
            setError(true)
